...
public class JOperator {
    ...
    public Observable<User> lastOperator(){
        return Observable.fromIterable(mUserEmptyList);
    }

    public Observable<User> distinctOperator() {
        return Observable.fromIterable(mUserList);
    }

    public Observable<User> skipOperator() {
        return Observable.fromIterable(mUserList);
    }

    public Observable<User> bufferOperator() {
        return Observable.fromIterable(mUserList);
    }

    public Observable<User> mapOperator() {
        return Observable.fromIterable(mUserList);
    }
